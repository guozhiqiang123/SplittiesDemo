 ...
 *description: 纯色描边头像Binder
 */
@Deprecated(message = "不适合使用这种方式")
class AvatarItemSolidBinder :
    BaseItemBinder<Tweet, AvatarItemSolidBinder.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        return MyViewHolder(AvatarItemUiSolid((parent.context)))
    }

    class MyViewHolder(val ui: AvatarItemUiSolid) : BaseViewHolder(ui.root) {
        init {
